...
const DECISION_MS = Number(process.env.ALPES_OS_DECISION_MS) || 15 * 60e3;  // how long a write tool waits on a click — a chat
// isn't Slack-instant; the user may be reading the proposed change carefully
